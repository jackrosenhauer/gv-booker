(function (window) {
    ...
    Controller.prototype.bodyHandler = function (event) {
        ...
        switch (id) {
            case "viewDay-button":
                console.log("show day view");
                //self.view.render("day", date);
                self.view.dayView(self.currentDate.getMonth(), self.currentDate.getDay(), self.currentdate.getYear(), self.defaultStartTime, self.defaultEndTime);
                break;
            case "viewWeek-button":
                //console.log("show week view");
                self.view.render("week", date);
                //console.log(id);
                break;
            case "viewMonth-button":
                //console.log("show month view");
                self.view.render("month", date);
                //console.log(id);
                break;
            default:
                //do nothing
